...
DESCRIPTION: This is a main driver code, through which we are printing 
             values from VectorN, for different operation on 
             objects of VectorN class.
******************************************************************/
...
int  main()
{
  ...
  const int ar22[] = {-5, 2, 6, 14, 0, 0, -6, 8};
  const int ar23[] = {2, 9, -3, 7, 8, -1, 2};
  const VectorN<int> v22(ar22, 8);
  const VectorN<int> v23(ar23, 7);
  cout <<"v22: " << v22 <<endl;
  cout << "v23: " <<v23 << endl;
  cout <<"v24 (v22 + v23) :" << v22+v23<< endl<< endl ;
  
  cout <<"v22: " << v22 <<endl;
  cout << "v23: " <<v23 << endl;
  cout <<"v24 (v23 + v22) :" << v23+v22<< endl<< endl ;
   
    
  const string ar25[] = {"Holly", "surf", "face", "light"};
  const string ar26[] = {"wood", "board", "book", "house"};
  
  const VectorN<string> v25(ar25,4);
  const  VectorN<string> v26(ar26,4);
